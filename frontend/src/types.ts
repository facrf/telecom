export type Client = { id: string; name: string; legalName: string; document: string; phone: string; email: string; contactName: string; address: string; city: string; state: string; postalCode: string; description: string; notes: string; createdAt?: string; updatedAt?: string }
export type Project = { id: string; clientId: string; name: string; description: string; location: string; address: string; localContact: string; notes: string; createdAt?: string; updatedAt?: string }
...
export type ScanHost = { ip: string; mac: string; hostname: string; status: string; discoveryMethod: string; discoveryMethods: string[]; manufacturer: string; deviceType: string; categoryId?: string; confidence: number; evidence: {source:string;detail:string;weight:number}[]; openPorts?: number[] }
export type ScanChange = { type: string; subject: string; previous: string; current: string; Type?: string; Subject?: string; Previous?: string; Current?: string }
